...
AI assistant used: GitHub Copilot (GPT-5.3-Codex). Tasks where AI was used: drafting and structuring this README, producing architecture diagrams, and improving wording clarity for algorithm explanations. All README technical statements were cross-checked against source modules before finalizing.
